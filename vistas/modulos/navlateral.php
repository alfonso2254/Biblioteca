		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box dashboard-sideBar-UserInfo">
				...
				<ul class="full-box list-unstyled text-center">
					<li>
						<a href="<?php echo SERVERURL; ?>mydata/<?php echo $tipo. $lc->encryption($_SESSION['codigo_bitacora_sbp']); ?>/" title="Mis datos">
							<i class="zmdi zmdi-account-circle"></i>
						</a>
					</li>
					<li>
						<a href="<?php echo SERVERURL; ?>myaccount/<?php echo $tipo . $lc->encryption($_SESSION['codigo_bitacora_sbp']); ?>/" title="Mi cuenta">
